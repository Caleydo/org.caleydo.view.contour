 ...
 *
 */
public class HTSVideoFactory implements IGLElementFactory {
 ...
 contour);
		...
		// // c = new AddChildColumnCommand(geneCollection,
		// pathwayColumn.getRootColumn().getColumnModel().getHistoryID(),
		...
		// c = new AddChildColumnCommand(compoundCollection,
		// groupColumn.getRootColumn().getColumnModel().getHistoryID(),
		// relationshipExplorer);
		// initCommand.add(c);
