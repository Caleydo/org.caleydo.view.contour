...
public class HCSActivityConfigurationAddon implements IItemFactoryConfigurationAddon {

	public static class HCSActivityItemFactoryCreator implements IItemFactoryCreator {

		protected static final URL PLOT_ICON = HCSActivityItemFactory.class
				.getResource("/org/caleydo/view/relationshipexplorer/icons/hbar.png");

		public static class HCSActivityItemFactory implements IItemFactory {
			...
			public HCSActivityItemFactory(TabularDataColumn column) {
				this.column = column;
			}
		...
		public IItemFactory create(IEntityCollection collection, IColumnModel column, ConTourElement contour) {
			return new HCSActivityItemFactory((TabularDataColumn) column);
		}
