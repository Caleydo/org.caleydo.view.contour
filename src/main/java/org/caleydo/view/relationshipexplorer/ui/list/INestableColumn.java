...
public class INestableColumn extends GLElementContainer {
	...
	protected class Column {
		protected GLElementContainer header;
	...
	protected class NestableItem extends GLElementContainer {
		...
		public NestableItem(GLElement representation, Column parent, NestableItem parentItem) {
			...
			for (Column column : parent.children) {
				addNestedContainer(column);
			}
			// updateSize();
	...
	public Column addRootColumn(String caption) {
		...
		column.header = createHeader(caption, headerRow);
	...
	private GLElement createTextElement(String text, float height) {
		...
		// GLElement captionElement = new GLElement(GLRenderers.drawRect(Color.GRAY));
	...
	public Column addNestedColumn(String caption, Column parent) {
		Column column = new Column();
		column.header = createHeader(caption, parent.header);
